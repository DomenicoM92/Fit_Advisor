      ...
      request(APIUrl + '?page=' + i, function (error, response, body) {
        MongoClient.connect(urlDB, { useNewUrlParser: true }, function (err, db) {
          ...
          for (var item in exercises) {
            if (checkBadResult(exercises[item].name) && exercises[item].description != undefined) {
...
function checkBadResult(name) {
  var rejectedValues = ["", "Test", "Test Pullups", "TestBicep", "Mart.05.035l", "What", "Awesome", "L-sit (tucked)", "52", "Abcd", "Developpé Couché", "Upper Body", "Snach", "BenchPress", "Arch Hold", "10 Min Abs", "Back Squat", "Run - Interval Training", "Boxing", "Circuit - Pullups", "Pushups", "Crunches", "Air Squats", "Squat", "Swimming", "Walking", "Bicep", "Nuevo", "Yolk Walks", "Soccer", "Circuit - Pullups, Pushups, Crunches, Air Squats", "Axe Hold"];
